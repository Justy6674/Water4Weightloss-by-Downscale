...
// The service account is sourced from the service-account.json file in the root.
// In a production setup, this should be loaded from a secure environment variable.
const serviceAccount: admin.ServiceAccount = {
  "type": "service_account",
  "project_id": "water4weightloss-by-downscale",
  "private_key_id": "1ee16fa2a16100ce4283ebc7dc86627f0d7e246a",
  // The private key is the most sensitive part. It's crucial that it's formatted
  // correctly with real newline characters. Using `||` provides a fallback.
  // The .replace() is now correctly applied to the result of the OR operation.
