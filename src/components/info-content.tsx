            ...
            <AccordionItem value="item-4">
                ...
                <AccordionContent>
                    <div className="space-y-6 pt-2 prose prose-invert prose-p:text-card-foreground/90 prose-headings:text-foreground prose-h3:text-xl prose-h4:text-lg prose-h5:font-bold prose-strong:text-foreground prose-ul:list-disc prose-ul:pl-6 prose-ul:space-y-2 prose-ol:list-decimal prose-ol:pl-6 prose-ol:space-y-2 prose-blockquote:border-primary prose-blockquote:text-muted-foreground">
                        ...
                        <h5><strong>Tirzepatide (Mounjaro / Zepbound)</strong></h5>
                        <p>A dual-agonist that acts on both GIP and GLP-1 receptors.</p>
                        <ul>
                            <li>In the SURMOUNT-1 trial, people without diabetes taking tirzepatide lost between <strong>15% to 20.9%</strong> of their body weight over 72 weeks, compared to just <strong>3.1%</strong> with placebo.<sup>[1]</sup></li>
                            ...
                            <li>Compared directly to Semaglutide 1mg, Tirzepatide showed greater weight loss in the SURPASS-2 trial (<strong>~11.2 kg vs ~5.7 kg</strong>).<sup>[3]</sup></li>
                        </ul>
                        
                        <h5><strong>Semaglutide (Ozempic / Wegovy / Rybelsus)</strong></h5>
                        ...
                        <ul>
                            ...
                            <li>When compared directly, the 2.4mg injection of Semaglutide led to more weight loss than daily Liraglutide 3.0mg (<strong>15.8% vs 6.4%</strong>).<sup>[7]</sup></li>
                            <li>Oral semaglutide (Rybelsus) has been shown to produce more modest weight loss (<strong>~4.3kg</strong>) in studies.<sup>[9]</sup></li>
                        </ul>

                        <h5><strong>Liraglutide (Saxenda)</strong></h5>
                        ...
                        <h5><strong>Phentermine (± topiramate)</strong></h5>
                        ...
                        <p>Naltrexone/bupropion (Contrave) can produce <strong>~5-6%</strong> weight loss<sup>[14]</sup>, and Orlistat (Xenical) yields <strong>~3%</strong> more weight loss than placebo<sup>[15]</sup>.</p>
                        ...
                        <ul>
                            <li><strong>Tirzepatide (Mounjaro/Zepbound):</strong> Up to <strong>~21%</strong> weight loss.<sup>[1]</sup></li>
                            <li><strong>Semaglutide (Wegovy):</strong> <strong>~15%</strong> weight loss.<sup>[4]</sup></li>
                            <li><strong>Liraglutide (Saxenda):</strong> <strong>~8%</strong> weight loss.<sup>[10]</sup></li>
                            <li><strong>Phentermine/Topiramate (Qsymia):</strong> <strong>~10-12%</strong> weight loss.<sup>[12]</sup></li>
                            <li><strong>Metformin:</strong> Typically <strong>&lt;5%</strong> body weight.<sup>[13]</sup></li>
                        </ul>
